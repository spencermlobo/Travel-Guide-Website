...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO mahasamadhi_bhumicomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: mahasamadhi_bhumi.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\mahasamadhi_bhumi.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM mahasamadhi_bhumicomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="bhandara.php">BHANDARA</a></h3>
        <img src="image\bhandara.jpg" alt="Maha" />
      </div>
      <div class="card">
