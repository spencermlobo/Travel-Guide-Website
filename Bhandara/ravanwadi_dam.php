...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO ravanwadi_damcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: ravanwadi_dam.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\ravanwadi_dam.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM ravanwadi_damcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        ...
        <img src="image\bhandara.jpg" alt="Pratap" />
      </div>
      <div class="card">
