...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO umred_karhandla_wildlife_santuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: umred_karhandla_wildlife_santuary.php");
  } else {
...
<head>
  ...
  <title>UMRED KARHANDLA WILDLIFE SANTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>UMRED KARHANDLA WILDLIFE SANTUARY</h1>
    ...
    <div class="left-column">
      ...
      <img src="image\umred_karhandla_wildlife_sanctuary.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM umred_karhandla_wildlife_santuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
      <h3><a href="bhandara.php">BHANDARA</a></h3>
        <img src="image\bhandara.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
