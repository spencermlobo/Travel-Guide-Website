...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO koka_wildlife_santuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: koka_wildlife_santuary.php");
  } else {
...
<head>
  ...
  <title>KOKA WILDLIFE SANTUARY</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\koka_wildlife_sanctuary.png" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM koka_wildlife_satuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="image\bhandara.jpg" alt="kaas" />
      </div>
      <div class="card">
