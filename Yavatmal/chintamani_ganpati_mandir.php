...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO chintamani_ganpati_mandircomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: chintamani_ganpati_mandir.php");
  } else {
...
<head>
  ...
  <title>CHINTAMANI GANPATI MANDIR</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>CHINTAMANI GANPATI MANDIR</h1>
    ...
    <div class="left-column">
      ...
      <img src="image\chintamani_ganpati_mandir .png" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      The Chintamani Temple of Theur is a Hindu temple dedicated to Ganesha, the elephant-headed god of wisdom. Located 25 km (16 mi) from Pune,[1] the temple is "one of the larger and more famous" of the Ashtavinayaka, the eight revered shrines of Ganesha in the Indian state of Maharashtra.
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="tipeshwar_wildlife_santuary.php">TIPESHWAR WILDLIFE SANTUARY</a></h3>
        <img src="image\tipeshwar_wildlife _sanctuary.jpeg" alt="kaas" />
      </div>
