...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO hazratturabulhaqshahdargahcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: hazrat turabul haq shah dargah.php");
  } else {
...
<head>
  ...
  <title>HAZRAT TURABUL HAQ SHAH DARGAH</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>HAZRAT TURABUL HAQ SHAH DARGAH</h1>
    <div class="left-column">
      ...
      <img src="images\Hazrat Turabul Haq Shah Dargah.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Hazrat Turabul Haq Shah Dargah is a tomb of great Sufi saint Hazrat Turabul Haq. The dargah is just about 5. 3 kilometres away from the Parbhani junction railway station.Hazrat Turabul Haq Shah Dargah is a tomb of Sufi saint Hazrat Turabul Haq, also known as Turatpeer Baba, who spent his last days in Parbhani. The Dargah is reach in history. The Dargah was built 108 years ago. Every year an annual festival takes place for 10 days here, when the area becomes crowded. The annual festival takes place between 2nd February and 15th February every year, when people from different community gather here to enjoy the festival.Hazrat Turabul Haq Shah Dargah can be visited during timings 6:00 AM - 9:00 PM.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM hazratturabulhaqshahdargahcomment";
        $result = mysqli_query($conn, $sql);
        if (
