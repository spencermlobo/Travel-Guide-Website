...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO bamboo_gardencomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: bamboo_garden.php");
  } else {
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d119270.55804778819!2d77.69170507394485!3d20.904072930606237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd6a4a67774bc15%3A0x3c7b3f78ca4f9635!2sAmravati%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1633604035230!5m2!1sen!2sin" width="300" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        <img src="images\bamboo_garden.jpg" width="670" height="300" />
        <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM baamboo_gardencomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="images\chatri_talao.jfif" alt="kaas" />
      </div>
      <div class="card">
      ...
      <div class="card">
      <h3><a href="wadali_lake.php">WADALI LAKE</a></h3>
