...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO gawilgarh_fortcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: gawilgarh_fort.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\gawilgarh_fort.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM gawilgarh_fortcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        ...
        <img src="images\chatri_talao.jfif" alt="Pratap" />
      </div>
      <div class="card">
