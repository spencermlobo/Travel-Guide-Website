...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO ambadeviandekviradevi_mandircomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: ambadeviandekviradevi_mandir.php");
  } else {
...
<head>
  ...
  <title>AMBADEVI AND EKVIRADEVI MANDIR</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>AMBADEVI AND EKVIRADEVI MANDIR</h1>
    ...
    <div class="left-column">
      ...
      <img src="images\ambadeviandEkviradevi_mandir.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      ...
      How to reach – It is 1 Km towards West from Amravati Railway station & 1.5 Km. from Amravati Bus Stand. Ample number of local vehicles and taxis are available from Amravati Railway station & Bus Stand. The Vehicles and Taxies are also available from Badnera railway station (on Mumbai – Calcutta Rail Route).
      ...
      Shri Ekvira Devi  Temple is situated in the vicinity of Amba devi Temple. This Temple is just a few steps away  from Amba devi Temple. This is a very  old Temple. It was built around the year 1660 by the great son of  Amravati Paramhans Shri Janardan Swami. Devi (Godess) is a incarnation of Shakti, during the Navaratri festival the celebration are not separate, everybody who visit Shri Amba Devi also visit Shri Ekvira devi Temple. Ample number of good quality staying facilities are available in various Hotels nearby.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM  ambadeviandekviradevi_mandircomment";
        $result = mysqli_query($conn, $sql);
        if (
