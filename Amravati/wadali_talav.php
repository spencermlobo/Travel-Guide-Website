...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO wadali_talavcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: wadali_talav.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\wadali_talav.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Wadali Talao is a popular reservoir sprawled on Chandur rail road at Amravati. It was built to supply fresh water to the residents of the city, now serves as a refreshing getaway to the dwellers and travelers of Amravati. Away from the hullaballoo of the city, Wadali Talao offers the peaceful environment around nature’s setting. The place has become tourists favourite hotspot who enjoy being close to the nature. The charm of this place over children is also not too less, because of the nearby zoo, whose amazing and cheerful inhabitants fascinate the kids. One can also delve into an exhilarating boating experience and other water sport activities in the region.

Wadali Talao Amravati is an ideal place for a picnic outing with family and friends, as it is just 3 km away from the city and can easily be reached by local transport. The best season to visit this place is during monsoon and winters, from July to February, when the reservoir is lush with clean water and weather is also pleasant.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM wadali_talavcomment";
        $result = mysqli_query($conn, $sql);
        if (
