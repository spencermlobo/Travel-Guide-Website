...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO sambhajilakecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: sambhaji lake.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Kambar Talav.JPG" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      The
...
fishing here!
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM sambhajilakecomment";
        $result = mysqli_query($conn, $sql);
        if (
