...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO greatindianbusterdsanctuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: great indian busterd sanctuary.php");
  } else {
...
<head>
  ...
  <title>GREAT INDIAN BUSTERD SANCTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>GREAT INDIAN INDIAN BUSTERD SANCTUARY</h1>
    ...
    <div class="left-column">
      ...
      <img src="images\great-Indian-bustard.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
...
place is a must visit attraction for locals and tourists alike.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM greatindianbusterdsanctuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="akkalkot swami temple.php">AKKALKOT SWAMI TEMPLE</a></h3>
        <img src="images\Akkalkot-swami.jpg" alt="kaas" />
      </div>
      <div class="card">
      <h3><a href="sambhaji lake.php">SAMBHAJI LAKE</a></h3>
        <img src="images\Kambar Talav.JPG" alt="Maha" />
      </div>
      <div class="card">
