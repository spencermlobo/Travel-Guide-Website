...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO botha_forestcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: botha_forest.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\botha_forest.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      The Dnyanganga Wildlife Sanctuary is situated 28 km from Buldhana and 20 km from Khamgaon town of Maharashtra. It is in Buldhana District, near the Dnyanganga River. There are two lakes within the 205 sq km sanctuary. Leopards, sloth bears, barking deer, blue bulls, spotted deer, hyenas, jungle cats and along with jackals give more attraction. About 150 species of birds are there. The ideal time to visit the sanctuary is throught the year. Wild animals are best sighted from February to May. The terrain is undulating, interspersed with hillocks having gentle slopes. Managed by the Office of Field Director- Melghat Tiger Reserve, Maharashtra Forest Department, The Sanctuary is a natural habitat for various animals and bird species of which many were seasonal that came from different parts of the country. Botha gate of Dnyanganga Wildlife Sanctuary is reachable by road from Khamgaon on the Khamgaon- Buldhana road. Shegaon is the nearest railway station, on Nagpur-Mumbai main line.
      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM botha_forestcomment";
        $result = mysqli_query($conn, $sql);
        if (
