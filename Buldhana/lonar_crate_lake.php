...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO lonar_crate_lakecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: lonar_crate_lake.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\lonar_crater_lake.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM lonar_crate_lakecomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        ...
        <img src="images\botha_forest.jfif" alt="Pratap" />
      </div>
