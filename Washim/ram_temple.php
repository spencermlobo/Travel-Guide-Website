...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO ram_templecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: ram_temple.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\ram_temple.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      This beautiful temple is estimated to be built around 250 years ago by Bhagvandas Maharaj Bairagi.  This temple comprises of beautiful idols of Lord Rama, Seeta, Lakshmana and Hanuman. Dharmashala is constructed opposite to the temple.  The sadhus take rest here and also used as a function hall. 
      On the opposite side of the Deo talav is a sanctuary devoted to Ramchandra, an expansive encased building yet not, by any methods as fine as the sanctuary of Baiaji. It contains pictures of Lakshmana, Sita, Maruti and Radha Krishna other than that of Ramchandra. It is said to have been worked by one Bhagvandas Maharaj Bairagi around 250 years prior. Before the sanctuary, has as of late been developed a two-storeyed dharmashala. It is utilized by the bairagis who visit the sanctuary. Marriage and such different religious capacities likewise occur in this dharmashala.
      ...
      There are daily bus services to Pune, Nashik, Mumbai, Nagpur, Hyderabad and Aurangabad. Both government run buses and private buses are available.
