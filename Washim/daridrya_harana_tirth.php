...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO daridrya_harana_tirthcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: daridrya_harana_tirth.php");
  } else {
...
<head>
  ...
  <title>DARIDRYA HARANA TIRTH</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\daridrya_harana_tirth .jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      The Daridrya-Harana Tirtha is said to have been created by Shri Dattatreya. Well built as the tank seems to have been formerly, the steps on only one side are noticeable now. By the side of the tank is a large banyan tree. One anecdote about the tirtha says that king Dashratha of Ayodhya, the father of Rama, killed Shravan by mistake by sitting over this tree.
      The Daridrya-harana Tirtha is said to have been created by Shri Dattatreya. Well built as the tank seems to have been formerly, the steps on only one side are noticeable now. By the side of the tank is a large banyan tree. One anecdote about the tirtha says that king Dashratha of Ayodhya, the father of Rama, killed Shravana by mistake by sitting over this tree.
    ...
    <div class="right-column">
      ...
      <h3><a href="ram_temple.php">RAM TEMPLE</a></h3>
        <img src="image\ram_temple.jfif" alt="Maha" />
      </div>
      <div class="card">
