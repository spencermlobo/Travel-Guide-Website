...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO vkrajwaderesearchboardcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: vk rajwade research board.php");
  } else {
...
<head>
  ...
  <title>V.K. RAJWADE RESEARCH BOARD</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>V.K. RAJWADE RESEARCH BOARD</h1>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM vkrajwaderesearchboardcomment";
        $result = mysqli_query($conn, $sql);
        if (
