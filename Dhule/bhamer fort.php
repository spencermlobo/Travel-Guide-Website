...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO bhamerfortcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: bhamer fort.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Bhamer Fort.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>This fort is kind of Giridurg. The height of sea level is 2500 meters. Bhamer fort is known as the capital of the kings. The fort has surrounded the village on three sides, while the fourth side gate has been built and the gateway has been built. There are 184 caves on this fort. Some of them caves can be seen. There is water tank and small temple on the fort. The bird’s eye view of the area from the fort is indescribable. It is a fort that should be visited once a fort. In 1818, the British defeated the Marathas and took control of the fort. In 1820, Kalekhan rebelled and rebuilt the fort. There is a mention of Captain Briggain’s removal of the column by the destruction of important buildings on the Bhamer fort.At distance of 48 kilometers from Dhule city  and 13 kilometers from Sakri the fort of Bhamer is situated. There is a famous place of pilgrimage of Jain devotees at a distance of 27 kilometers from this fort. Here too, many Jain devotees from all over the country come to visit. In this temple Lord Vimalnath has a black stone statue.
      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM bhamerfortcomment";
        $result = mysqli_query($conn, $sql);
        if (
