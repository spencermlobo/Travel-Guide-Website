...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO nakanelakecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: nakane lake.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Nakane Lake.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>This lake is very close to the city of Dhule. This is a main water reservior of Dhule city.
You can watch local and migrated birds here early in the morning. Migrated birds can be watched during November to February. During monsoon you can watch the local ducks and goose. Every year more than 200 species of birds are visiting the lake; like Shelduck, Shoveler,Pigeon, Dove, Pochard, Coucal, Cukoo, Koyel, Nightjar, Waterhen, Stork, Cormorant and so others. The lake is hardly 3-4 Km from the City. You may require your own vehicle to visit the place. It is open for all and are no ticket charges. Please ensure equipped for full length track suit, cap, water bottle, snacks and insect repellent. Be cautious about poisonous serpents. All The Best. Even you find more than 200 species, the site is rated with 3 star, as you will not find walking track or watch towers or guides or any other facilities by the authorities. It's an open Jungle.
</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM nakanelakecomment";
        $result = mysqli_query($conn, $sql);
        if (
