...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO songirfortcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: songir fort.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Songir Fort.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>After seeing the Lalling forts, Dhule is a village on the Mumbai-Agra highway, on the north side of the 19 km away Songir village. Songir village near by a suvarngiri or songir fort. It is built in a very important place. It is 304 meters high above sea level. From 1370, information available for the songir fort. This fort was in the possession of Farooqi Sultans. After that he went under the control of the Mughals, Marathas and later the British. The British conquered it in 1818. The rounded bastions in black stone absorbs attention. The remains of this fort have also collapsed.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM songirfortcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="ekvira devi temple.php">EKVIRA DEVI TEMPLE</a></h3>
        <img src="images\Ekvira Devi Temple.jpg" alt="EKVIRA DEVI TEMPLE" />
      </div>
      <div class="card">
