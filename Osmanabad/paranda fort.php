...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO parandafortcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: paranda fort.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Paranda Fort.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Paranda Fort is situated in Paranda, a small town in the Osmanabad district in the state of Maharashtra, India. It is protected monument by the Archaeological Survey Of India. The fort may have been constructed in the 15th century by Mahmud Gawan or by Murtaza Nizam Shah II in the early 1600s.In 1599, Mughals defeated Nizam Shahi of Ahmednagar. Though Emperor Akbar appointed his officers to look after the kingdom of the Deccan, the Nizam Shah’s officers refused to receive orders from them. They had lost their independence. They declared Murtaza, the son of Shah Ali king and made Paranda Fort, about 75 miles south east of Ahmednagar capital. The site passed several times between them and the Adil Shahis and remained with him for two to three years and was captured by the Adil Shah in 1630. In 1657 it was again captured by the Moghuls and eventually came into the hands of the Nizams of Hyderabad.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM parandafortcomment";
        $result = mysqli_query($conn, $sql);
        if (
