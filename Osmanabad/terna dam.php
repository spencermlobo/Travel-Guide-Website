...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO ternadamcomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Terna Dam.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Terna Dam, is an earthfill dam on Terna river near Osmanabad in the state of Maharashtra in India.
The height of the dam above its lowest foundation is 15 m (49 ft) while the length is 2,651 m (8,698 ft). The volume content is 186 km3 (45 cu mi) and gross storage capacity is 22,910.00 km3 (5,496.40 cu mi)
The main purpose of the dam is to supply water for irrigation and domestic purpose to nearby villages. Earlier, it was used to supply the water to Osmanabad city.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM ternadamcomment";
        $result = mysqli_query($conn, $sql);
        if (
