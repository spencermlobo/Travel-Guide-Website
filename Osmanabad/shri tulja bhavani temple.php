...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO shrituljabhavanitemplecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: shri tulja bhavani temple.php");
  } else {
...
<head>
  ...
  <title>TULJA BHAVANI TEMPLE</title>
  ...
  <div class="row">
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM shrituljabhavanitemplecomment";
        $result = mysqli_query($conn, $sql);
        if (
