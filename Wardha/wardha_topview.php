...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO wardha_topviewcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: wardha_topview.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\wardha_topview.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM wardha_topviewcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        ...
        <img src="image\sevagram_ashram.jpg" alt="Pratap" />
      </div>
