...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO vishwa_shantistupacomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: vishwa_shantistupa.php");
  } else {
...
<head>
  ...
  <title>VISHWA SHANTISTUPA</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\vishwa_shantistupa.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM vishwa_shantistupacomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
      <h3><a href="sevagram_ashram.php">SEVAGRAM ASHRAM</a></h3>
        <img src="image\sevagram_ashram.jpg" alt="Maha" />
      </div>
      <div class="card">
