...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO sevagram_ashramcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: sevagram_ashram.php");
  } else {
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>SEVAGRAM ASHRAM</h1>

    <div class="left-column">
      <div class="card"></div>
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59696.72166782165!2d78.57766598607019!3d20.74896587028458!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd47f04f15aa69d%3A0xe76e35b13382a66c!2sWardha%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1633606208829!5m2!1sen!2sin" width="300" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
      <img src="image\sevagram_ashram.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Sevagram is a small village near Wardha town (8 km). Mahatma Gandhi reached the village on the 30th April,1936 early in the morning at about 5 a.m. He remained here for about five to six days. He called the villagers and the purpose of his visit and sought their permission to settle down here. He had no intention to keep anybody with him except his wife Kasturba.
      However slowly pressure of work necessitated permission to more colleagues till Sevagram Ashram also became a full-fledged institution.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM sevagram_ashramcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="gitai_mandir.php">GITAI MANDIR</a></h3>
        <img src="image\gitai_mandir.jpg" alt="kaas" />
      </div>
      <div class="card">
      <h3><a href="vishwa_shantistupa.php">VISHWA SHANTISTUPA</a></h3>
        <img src="image\vishwa_shantistupa.jpg" alt="Maha" />
      </div>
      <div class="card">
        <h3><a href="wardha_topview.php">WARDHA TOPVIEW</a></h3>
        <img src="image\wardha_topview.jpg" alt="Pratap" />
      </div>
