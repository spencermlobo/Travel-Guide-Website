...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO nazira_wildlife_santuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: nazira_wildlife_santuary.php");
  } else {
...
<head>
  ...
  <title>NAZIRA WILDLIFE SANTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>NAZIRA WILDLIFE SANTUARY</h1>
    ...
    <div class="left-column">
      ...
      <img src="image\nazira_wildlife_santuary.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM nazira_wildlife_santuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="kachargadh_caves.php">KACHARGADH CAVES</a></h3>
        <img src="image\kachargadh_caves.jpg" alt="kaas" />
      </div>
      <h3><a href="kachargadh_caves.php">KACHARGADH CAVES</a></h3>
        <img src="images\2018032377-1024x682.jpg" alt="kaas" />
      </div>
