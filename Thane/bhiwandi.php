...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO bhiwandicomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\bhiwandi.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Located a little outside Thane, Bhiwandi is a little city in the Konkan district of Maharashtra. Owing to its leading textile industries and warehouses, Bhiwandi is often dubbed as the Manchester of India. The sheer number of Hindu temples in Bhiwandi makes it one of the most popular tourist places in Thane among Hindu pilgrims.

      The Jankai Devi Temple, Gaav Devi Temple, and the Shankar Temple are only some of them. There are several stunning waterfalls and lakes around the city as well, adding to the charm of the place. The best time to visit the town is during the festival of Ganesh Chaturthi, which is celebrated with a lot of pomp and splendor here.

      Location: Konkan District, 15 kilometers from Thane.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM bhiwandicomment";
        $result = mysqli_query($conn, $sql);
        if (
