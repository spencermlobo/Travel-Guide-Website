...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO basilica_og_our_lady_of_the_meetingcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: basilica_og_our_lady_of_the_meeting.php");
  } else {
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>BASILICA OF OUR LADY OF THE MOUNT</h1>
    ...
    <div class="left-column">
      ...
      <img src="images\basilica_of_our_lady_of_the_mount.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      The Basilica of Our Lady of the Mount, more commonly known as Mount Mary Church, is a Roman Catholic Basilica located in Bandra, Mumbai The feast of the Blessed Virgin Mary is celebrated here on the first Sunday after 8 September, the birthday of the Virgin Mary. The feast is followed by a week-long celebration known locally as the Bandra Fair and is visited by thousands of people. Many pilgrims visit the Basilica of Our Lady of the Mount in order to pray for their mannat to come true, especially during the annual Bandra Fair.
      Every year, millions of tourists and devotees flock here to receive graces from the Lady of the Mount.
      Mount Mary Church Bandra – The Basilica of Our Lady of the Mount, commonly known as Mount Mary Church, is a Roman Catholic Basilica located in Bandra, Mumbai.
      ...
      In 1700, the Arab pirates interested in the gilt-lined object held in hand disfigured the statue and cut the right hand.
      There are masses held in the mornings. Devotes need to first pass through the church by offering flowers and candles, followed by entering the fair where you have all types of rides, sweets, household items, children’s toys, etc.  The fair is on for around 7 days.
 
      Bandra Fair attracts lakhs of pilgrim devotees every year. People of all faiths and religions come to this feast to ask for favors or to thank Mother Mary for the favors granted.
      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM basilica_og_our_lady_of_the_meetingcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="kanheri_caves.php">KANHERI CAVES</a></h3>
        <img src="images\kanheri_caves.jfif" alt="kaas" />
      </div>
      <div class="card">
      ...
      <div class="card">
        ...
        <img src="images\bandra_fort.jfif" alt="Pratap" />
      </div>
      <div class="card">
