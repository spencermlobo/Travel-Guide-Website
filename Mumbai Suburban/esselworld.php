...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO esselworldcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: esselworld.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\esselworld.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      EsselWorld is an amusement park located in Gorai on Dharavi island, Mumbai.[1] It covers an area of 65 acres along with Water Kingdom, and was opened to the public in 1989.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM esselworldcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="bandra_fort.php">BANDRA FORT</a></h3>
        <img src="images\bandra_fort.jfif" alt="Maha" />
      </div>
      <div class="card">
