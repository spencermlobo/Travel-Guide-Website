...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO bandra_fortcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: bandra_fort.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\bandra_fort.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      ...
      It was built by the Portuguese in the year 1640 as a watchtower overlooking the Mahim Bay, the Arabian Sea and the southern island of Mahim after defeating Bahadur Shah of Gujarat. The fort was partially destroyed by the Britishers after the decline of the Portuguese in the 18th century as a precautionary measure. The demolition was to nullify the possibility of the fort being captured by the Marathas, with the possibility of it being used as a forward military base to attack British Bombay.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM bandra_fortcomment";
        $result = mysqli_query($conn, $sql);
        if (
