...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO global_vipassana_pagodacomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: global_vipassana_pagoda.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\global_vipassana_pagoda.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      The Global Vipassana Pagoda is a Meditation dome hall with a capacity to seat around 8,000 Vipassana meditators near Gorai, north-west of Mumbai, Maharashtra, India. The pagoda was inaugurated by Pratibha Patil, then President of India, on 8 February 2009. It is built on donated land on a peninsula between Gorai creek and the Arabian Sea. The pagoda is to serve as a monument of peace and harmony. The Global Vipassana Pagoda has been built out of gratitude to Sayagyi U Ba Khin, Vipassana teacher and the first Accountant-General of Independent Burma, who was instrumental in Vipassana returning to India, the country of its origin. Built entirely through voluntary donations, the purpose of the Global Vipassana Pagoda is to: 1 share information about Vipassana, and 2 spread information on Gotama the Buddha and his teachings. Vipassanā is the practical quintessence of the universal, non-sectarian teachings of the Buddha. Its traditional Burmese design is an expression of gratitude towards the country of Myanmar for preserving the practice of Vipassana. The shape of the pagoda is a copy of the Shwedagon Pagoda in Yangon, Myanmar.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM global_vipassana_pagodacomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="bandra_fort.php">BANDRA FORT</a></h3>
        <img src="images\bandra_fort.jfif" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
