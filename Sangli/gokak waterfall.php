...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO gokakwaterfallcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: gokak waterfall.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Gokak-Waterfall.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM gokakwaterfallcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        <h3><a href="gokak waterfall.php">CHANDOLI NATIONAL PARK</a></h3>
        <img src="images\Chandoli-National-Park.jpg" alt="Pratap" />
      </div>
      <div class="card">
      <h3><a href="sagareshwar wildlife sanctuary.php">SAGRESHWAR WILDLIFE SANCTUARY</a></h3>
        <img src="images\Sagareshwarwildlifesanctuary.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
