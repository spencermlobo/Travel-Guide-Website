...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO bahubaligomateshwartemplecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: bahubali gomateshwar temple.php");
  } else {
...
<head>
  ...
  <title>BAHUBALI GOMATESHWAR TEMPLE</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>BAHUBALI GOMATESHWAR TEMPLE</h1>
    ...
    <div class="left-column">
      ...
      <img src="images\Bahubali_Gomateshwara_Temple_1.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM bahubaligomateshwartemplecomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="images\Chandoli-National-Park.jpg" alt="kaas" />
      </div>
      <div class="card">
      ...
      <div class="card">
      <h3><a href="sagareshwar wildlife sanctuary.php">SAGRESHWA WILDLIFE SANCTUARY</a></h3>
