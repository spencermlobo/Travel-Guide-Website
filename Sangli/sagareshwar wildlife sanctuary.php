...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO sagreshwarwildlifesanctuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: sagareshwar wildlife sanctuary.php");
  } else {
...
<head>
  ...
  <title>SAGARESHWAR WILDLIFE SANCTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>CHANDOLI NATIONAL PARK</h1>

    <div class="left-column">
      <div class="card"></div>
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61094.960394236936!2d74.54908036872342!3d16.854361476239053!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc10c8187f060eb%3A0x37911f53cdc1ddb3!2sSangli%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1633605980838!5m2!1sen!2sin" width="300" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
      <img src="images\Sagareshwarwildlifesanctuary.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM sagareshwarwildlifesanctuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="bahubali gomateshwar temple.php">BAHUBALI GOMTESHWAR TEMPLE</a></h3>
        <img src="images\Bahubali_Gomateshwara_Temple_1.jpg" alt="kaas" />
      </div>
      <div class="card">
      <h3><a href="dandoba hills.php">DANDOBA HILLS</a></h3>
        <img src="images\Dandoba-Hills-Forest-Reserve.jpg" alt="Maha" />
      </div>
      <div class="card">
        <h3><a href="gokak waterfall.php">GOKAK WATERFALL</a></h3>
        <img src="images\Gokak-Waterfall.jpg" alt="Pratap" />
      </div>
      <div class="card">
      <h3><a href="chandoli national park.php">CHANDOLI NATIONAL PARK</a></h3>
        <img src="images\Chandoli-National-Park.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
