...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO dandobahillscomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: dandoba hills.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Dandoba-Hills-Forest-Reserve.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM dandobahillscomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="chandoli national park.php">CHANDOLI NATIONAL PARK</a></h3>
        <img src="images\Chandoli-National-Park.jpg" alt="Maha" />
      </div>
      <div class="card">
