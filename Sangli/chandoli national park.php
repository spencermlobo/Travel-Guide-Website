...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO chandolinationalparkcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: chandoli national park.php");
  } else {
...
<head>
  ...
  <title>CHANDOLI NATIONAL PARK</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Chandoli-National-Park.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM chandolinationalparkcomment";
        $result = mysqli_query($conn, $sql);
        if (
