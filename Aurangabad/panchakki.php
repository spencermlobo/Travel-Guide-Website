...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO panchakkicomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Panchakki.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Today, we might be living in a world, where science and technology have achieved giant milestones. However, looking at the Panchakki in Aurangabad, we cannot deny the fact, medieval India was also up to date with science and technology of their own kinds.
...
Around the mill, you can find the Baba Shah Musafir Dargah, a sprawling garden, and several other monuments. It also offers amazing views of the Kham River and the cenotaph of Baba Shah Musafir and a few graves that belong to his disciples. One of the scientific marvels of the olden times, it is truly one of the not to be missed places to visit in Aurangabad!</h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM panchakkicomment";
        $result = mysqli_query($conn, $sql);
        if (
