...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO grishneshwartemplecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: grishneshwar temple.php");
  } else {
...
<head>
  ...
  <title>GRISHNESHWAR TEMPLE</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Grishneshwar Temple.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>An important pilgrimage for the Hindus, this ancient temple is located in a quaint hamlet that is around 30 km from Aurangabad and also lies within the limits of the historic Ellora Caves. A major name in the list of tourist places near Aurangabad, the temple is considered as a pious destination by the Hindu devotees. It is also said that it is the last or the 12th 'Jyotirlinga' on earth.
Built-in pre-historical architectural style and in red bricks with the walls showcasing the carvings of several Hindu Gods and Goddesses, the temple was later renovated during the 18th century. According to the legends, holy water springs out from inside the temple and purifies one heart and soul.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM grishneshwartemplecomment ";
        $result = mysqli_query($conn, $sql);
        if (
