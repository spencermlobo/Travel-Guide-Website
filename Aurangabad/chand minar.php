...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO chandminarcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: chand minar.php");
  } else {
  ...
  <div class="row">
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM chandminarcomment";
        $result = mysqli_query($conn, $sql);
        if (
