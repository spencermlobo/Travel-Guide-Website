...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO bibikamaqbaracomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: bibi ka maqbara.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Bibi Ka Maqbara.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>The Bibi Ka Maqbara is a tomb located in Aurangabad, Maharashtra, India. It was commissioned in 1660 by the Mughal emperor Aurangzeb's son in the memory of his mother Dilras Banu Begum (posthumously known as Rabia-ud-Daurani) and is considered to be a symbol of Aurangzeb's 'conjugal fidelity'.It bears a striking resemblance to the Taj Mahal, the mausoleum of Aurangzeb's mother, Mumtaz Mahal.Aurangzeb was not much interested in architecture though he had commissioned the small, but elegant, Pearl Mosque at Delhi. Bibi Ka Maqbara is the second largest structure that Aurangzeb has built, the largest being the Badshahi Mosque.The comparison to the Taj Mahal has often obscured its very own considerable charm.[8] Due to the strong resemblance, it is also called the Dakkhani Taj (Taj of the Deccan).Bibi Ka Maqbara is the "principal monument" of Aurangabad and its historic city.An inscription found on the main entrance door mentions that this mausoleum was designed and erected by Ata-ullah, an architect and Hanspat Rai, an engineer respectively. Ata-ullah was the son of Ustad Ahmad Lahauri, the principal designer of the Taj Mahal. Aurangzeb's son, Muhammad Azam Shah was in later years put in charge of overseeing the repair-work of the mausoleum by Shah Jahan.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM bibikamaqbaracomment";
        $result = mysqli_query($conn, $sql);
        if (
