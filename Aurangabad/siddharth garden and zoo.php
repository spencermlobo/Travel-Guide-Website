...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO siddharthgardenandzoocomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: siddharth garden and zoo.php");
  } else {
...
<head>
  ...
  <title>SIDDHARTH GARDEN AND ZOO</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>SIDDHARTH GARDEN AND ZOO</h1>
    <div class="left-column">
      ...
      <img src="images\Siddharth Garden and Zoo.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>One of those Aurangabad tourist places that promise to turn an ordinary day into a delightful one, Siddharth Garden and Zoo is an ideal place to visit with family. It is a landscaped garden replete with a large variety of flowering plants and trees, an aquarium, and, unlike the usual gardens, a zoo – all in all, a favourite weekend spot for locals.
While the garden provides plenty of space with calm atmosphere for relaxation, the zoo has some exotic species on display ranging from tigers and elephants to crocodiles and snakes. So, whether you want to take your kids out to educate them about wildlife or you are looking for a pretty spot for family picnic, this garden cum zoo must fit the bill.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM siddharthgardenandzoocomment";
        $result = mysqli_query($conn, $sql);
        if (
