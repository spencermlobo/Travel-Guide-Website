...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO dabhosa_waterfallscomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: dabhosa_waterfalls.php");
  } else {
...
<head>
  ...
  <title>DABHOSA WATERFALLS</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\dabhosa_waterfalls.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Dabhosa Waterfalls is a waterfalls situated in the village of Dabhosa in Jawhar Tehsil, palghar district, Maharashtra, India. This is one of the highest waterfalls situated near Mumbai.This waterfalls is located over the Lendi River and cascades down from a height of 300 feet. Dabhosa Waterfalls is a beautiful waterfall especially, during the monsoon season.[1]
      Dabhosha waterfalls is an adventurous spot for kayaking, trekking, valley crossing, and fishing.
      Dabhosa is one of the very few waterfalls which are perennial. They flow in every season. Besides, it one of the highest waterfalls in Maharashtra. The crater shape into which the water cascades and the lake at its bottom is a rare spectacle. Adventurers come here for various exciting activities such as rappelling, valley crossing through glorious waterfall, trekking, kayaking, Burma Bridge, laddering, night walk, and jungle cooking.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM dabhosa_waterfallscomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="images\bahrot_caves.jpg" alt="kaas" />
      </div>
      <div class="card">
