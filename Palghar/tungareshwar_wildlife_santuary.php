...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO tungareshwar_wildlife_santuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: tungareshwar_wildlife_santuary.php");
  } else {
...
<head>
  ...
  <title>TUNGARESHWAR WILDLIFE SANTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>TUNGARESHWAR WILDLIFE SANTUARY</h1>
    ...
    <div class="left-column">
      ...
      <img src="images\tungareshwar_wildlife_sanctuary.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Tungareshwar wildlife sanctuary also known as Tungareshwar National Park is located on a plateau east of Vasai and Virar in Palghar district,[1] north of Mumbai in the Indian state Maharashtra.
      The sanctuary is over 85 km2 and forms a corridor between Sanjay Gandhi National Park and Tansa wildlife sanctuary.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM tungareshwar_wildlife_santuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
        <h3><a href="bahrot_caves.php">BAHROT CAVES</a></h3>
        <img src="images\bahrot_caves.jpg" alt="Pratap" />
      </div>
      <div class="card">
