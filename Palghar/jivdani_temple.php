...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO jivdani_templecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: jivdani_temple.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\jivdani_temple.jfif" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM jivdani_templecomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="bahrot_caves.php">BAHROT CAVES</a></h3>
        <img src="images\bahrot_caves.jpg" alt="Maha" />
      </div>
      <div class="card">
