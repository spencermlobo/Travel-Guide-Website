...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO tungareshwar_templecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: tungareshwar_temple.php");
  } else {
...
<head>
  ...
  <title>TUNGARESHWAR TEMPLE</title>
  ...
  <div class="row">
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM tungareshwar_templecomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="bahrot_caves.php">BAHROT CAVES</a></h3>
        <img src="images\bahrot_caves.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
