...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO shanishingnapurcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: shani shingnapur.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Shani Shingnapur.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Shani  Shingnapur Temple is a famous temple which is located at a distance of 65 kilometers from Shirdi nestled in the Ahmednagar district. 
This popular temple is dedicated to Lord Shanidev, the popular Hindu god associated with the planet Saturn. 
The temple is well known amongst the locals and devotees from all around India. Apart from the temple,
Shingnapur is a small village which is also famous for the fact that in the whole village no house has doors and 
despite this no theft has been reported in the village.
The presiding deity in the temple is Lord Shani and the temple is a “Jagrut Devasthan” (alive temple) 
which means that a deity still resides in the temple premises. The main deity of the temple is 
Swayambhu which is self emerged from the earth in the form of black imposing stone. 
It is said that the deity is in the existence since the beginning of Kali Yuga. However, no one is sure of the exact time.  
...
Entry Charges: NO Entry Fee
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM shanishingnapurcomment";
        $result = mysqli_query($conn, $sql);
        if (
