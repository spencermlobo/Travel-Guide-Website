...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO kankaleshwartemplecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: kankaleshwar temple.php");
  } else {
...
<head>
  ...
  <title>KANKALESHWAR TEMPLE</title>
  ...
  <div class="row">
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM kankaleshwartemplecomment";
        $result = mysqli_query($conn, $sql);
        if (
