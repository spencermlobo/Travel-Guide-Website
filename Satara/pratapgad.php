...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO  pratapgadcomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Pratapgad-966x1024.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
...
The historic battle between Chatrapati Shivaji and Afzal Khan, the commander of the Bijapur Sultanate fought here. Bhavani Temple and Afzal Khan's Tomb are major attractions where are situated near the fort.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM pratapgadcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <h3><a href="kaas pathar.php">KAAS PATHAR</a></h3>
        <img src="images\Kaas Pathar.jpeg" alt="Maha" />
      </div>
      <div class="card">
