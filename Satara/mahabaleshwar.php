...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO mahabaleshwarcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: mahableshwar.php");
  } else {
...
Places of interest is called as “Point” in Mahabaleshwar as most of them are at the end of mountains.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM mahabaleshwarcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="images\Kaas Pathar.jpeg" alt="kaas" />
      </div>
      <div class="card">
      ...
      <div class="card">
      <h3><a href="ajinkyatara.php">AJINKYATARA</a></h3>
        <img src="images\Ajinkyatara.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
