...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO sewri_mangrove_parkcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: sewri_mangrove_park.php");
  } else {
...
<head>
  ...
  <title>SEWRI MANGROVE PARK</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\sewri _mangrove_park.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      ...
      Sewri Flamingo Point Mumbai, is a place near Sewri locality in Maharashtra state of India.[1]
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM sewri_mangrove_parkcomment";
        $result = mysqli_query($conn, $sql);
        if (
