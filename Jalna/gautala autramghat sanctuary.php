...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO gautalaautramghatsanctuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: gautala autramghat sanctuary.php");
  } else {
...
<head>
  ...
  <title>GAUTALA AUTRAMGHAT SANCTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>GAUTALA AUTRAMGHAT SANCTUARY</h1>
    <div class="left-column">
      ...
      <img src="images\Gautala Autramghat Sanctuary.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Gautala Autramghat Sanctuary is a protected area of Maharashtra state, India. It lies in the Satmala and Ajantha hill ranges of the Western Ghats, and administratively is in Aurangabad District and Jalgaon District. The wildlife sanctuary was established in 1986 in an existing reserved forest area.
It covers a total area of 26,061.19 hectares (64,399 acres) with Reserved Forest Areas of 19706 ha. in Aurangabad and 6355.19 ha. in Jalgaon.Its name comes the nearby village of Gautala, which was itself named after Gautam Rishi, a Hindu ascetic mentioned in the Ramcharitmanas.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM gautalaautramghatsanctuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
