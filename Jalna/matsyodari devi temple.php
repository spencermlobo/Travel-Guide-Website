...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO matsyodaridevitemplecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: matsyodari devi temple.php");
  } else {
...
<head>
  ...
  <title>MATSYODARI DEVI TEMPLE</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Matsyodari Devi Temple.jpg" width="670" height="300"/>
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>The temple is dedicated to goddess Matsyadevi . The name of the deity and the temple is derived from the shape of the hill which looks like a fish. The temple is believed to be the most ancient in the region. There is an annual fair held every year in October, during the Sharad Navratri celebration, in this temple.
      The temple is situated near Jalna city in Ambad and none as one of the oldest temple in the district. This district at one time was under the rule of the Nizam. It became a part of India, only after Marathwada Mukti Sangram.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM matsyodaridevitemplecomment";
        $result = mysqli_query($conn, $sql);
        if (
