...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO asthambacomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Asthamba.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Asthamba is the religious place of Nandurbar region and is located in Akrani Tehsil. Asthamba fair held here is considered to be one of the most prominent fairs of tribals from south Gujarat and North West Maharashtra. During Diwali festival, the fair is held for 10 to 15 days. Asthamba is considered as one of the mythological characters from Hindu epic Mahabharata. According to tribals, he is known by the name of Ashvasthama, a male character and was the son of Guru Dronacharya.
      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM asthambacomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      ...
      <div class="card">
      <h3><a href="syed allaudin urf imam sahebs dargah.php">SYED ALLAUDDIN URF IMAM SAHEB'S DARGAH</a></h3>
        <img src="images\Syed Allaudin Urf Imam Saheb's Dargah.jpg" alt="SYED ALLAUDDIN URF IMAM SAHEB'S DARGAH" />
      </div>
      <div class="card">
