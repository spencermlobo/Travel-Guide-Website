...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO toranmalcomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Toranmal.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
...
Toranmal is a small plateau with an approximate area of 41.43 sq. kilometers. The plateau has a soccer like shape from which a stream flows across the plateau from south to north. In southern part of the plateau, stream is bounded and forms the Yashavant Lake which spans about 1.59 km2 and has a maximum depth of 27 meters. Further towards the north on the same stream is the Lotus lake which derives its name from the fact that it is always covered with lotus flowers. Same stream jumps down the cliff in Sita Khai, into the gorge forming an entralling waterfall in rainy season.      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM toranmalcomment";
        $result = mysqli_query($conn, $sql);
        if (
