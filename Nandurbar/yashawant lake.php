...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO yashawantlakecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: yashawant lake.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Yashawant Lake.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      To the southern part of Toranmal is the Yashwant Lake. It is also known as Kamal Talao which is covered with lotus flowers. The water from the steam flows into the Sita Khai in the forests. Tourists can get to see this beautiful lake filled with lotuses and the chilling water that flows into the Sita Khai.      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM yashawantlakecomment";
        $result = mysqli_query($conn, $sql);
        if (
