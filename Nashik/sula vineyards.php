...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO sulavineyardscomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: sula vineyards.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Sula Vineyards.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Sula Vineyards is a winery and vineyard located in the Nashik region of western India, 180 km northeast of Mumbai. 
It was founded by Rajeev Samant in 1999.Sula has grown to be India’s largest and most awarded wine brand. 
Sula introduced grape varietals such as Chenin blanc, Sauvignon blanc, Riesling and Zinfandel in India and is the
leading player in the Indian wine industry.
History:
Sula Vineyards was founded by Mr. Rajeev Samant in the late 1990s. An alumnus of Stanford University, 
he worked at Oracle in California after his graduation. After quitting his corporate job, Mr. Samant established Sula
 upon his return to India.Sula was named after Samant's mother – 'Sulabha'. Samant steadily grew the company 
over the next few years by introducing newer grape varieties and expanding the company's offerings. 
Over the last few decades, the Nashik region has transformed and is often referred to as "India’s Napa Valley"
      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM sulavineyardscomment";
        $result = mysqli_query($conn, $sql);
        if (
