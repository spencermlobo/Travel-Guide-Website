...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO saptashrungicomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: saptashrungi.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Saptashrungi.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Saptashringi is a site of Hindu pilgrimage situated 60 kilometres (37 mi) from Nashik in Indian state of Maharashtra. 
According to Hindu traditions, the goddess Saptashrungi Nivasini dwells within the seven mountain peaks. 
(Sapta means seven and shrung means peaks.) It is located in Nanduri, Kalwan taluka, a small village near Nashik in India. 
The Marathas and some Bhil tribes worship the goddess from a long time and some worship as their kuldaivat.
There are 510 steps to climb the gad. Devotees visit this place in large numbers every day.
The temple is also known popularly as one of the "three and half Shakti Peethas" of Maharashtra.
The temple is also one among the 51 Shakti Peethas located on the Indian subcontinent and is a 
location where one of Sati's (wife of Lord Shiva) limbs, her right arm is reported to have fallen. 
Its half shaktipeeth among three and half shaktipeeth of Maharashtra.
      </h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM saptashrungicomment";
        $result = mysqli_query($conn, $sql);
        if (
