...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO kumbhamelacomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: kumbha mela.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Kumbha Mela.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
...
on 10 February 2013 and 50 million on 4 February 2019.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM kumbhamelacomment";
        $result = mysqli_query($conn, $sql);
        if (
