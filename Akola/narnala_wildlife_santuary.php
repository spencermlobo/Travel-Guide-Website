...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO narnala_wildlife_santuarycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: narnala_wildlife_santuary.php");
  } else {
...
<head>
  ...
  <title>NARNALA WILDLIFE SANTUARY</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>NARNALA WILDLIFE SANTUARY</h1>
    ...
    <div class="left-column">
      ...
      <img src="images\narnala_wildlife_sanctuary.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM narnala_wildlife_santuarycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <h3><a href="narnala_fort.php">NARNALA FORT</a></h3>
      ...
      <div class="card">
      <h3><a href="rajeshwar_temple.php">RAJESHWAR TEMPLE</a></h3>
        <img src="images\rajeshwar_temple.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
