...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO narnala_fortcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: narnala_fort.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\narnala_Fort.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      ...
      The fort is located in the Akot Taluka of Akola district, Berar at coordinates of 20.703 N and 76.997 E. The closest city is Akot, which is 18 km away. It is at the southernmost tip of the Satpura Hills at an elevation of 932 meters above sea level.[1] Currently the fort falls within the Melghat Tiger Reserve. Climate of Narnala fort is classified as Humid subtropical (Cwa) as per Köppen-Geiger climate classification with mild to cool winters (November to March), wet Monsoon season (June to October) and hot long summer (March to June). Temperature ranges from 5 °C to 23 °C in winter, 17 °C to 42 °C in summer and 15 °C to 30 °C in Monsoon.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM narnala_fortcomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="images\rajeshwar_temple.jpg" alt="kaas" />
      </div>
      <div class="card">
      ...
      <div class="card">
      <h3><a href="narnala_wildlife_santuary.php">NARNALA WILDLIFE SANTUARY</a></h3>
