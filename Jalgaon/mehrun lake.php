...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO mehrunlakecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: mehrun lake.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="images\Mehrun Lake.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Mehrun lake is one such beautiful mood of nature where every organism associated with the ecosystem of Mehrun performs is beautiful role in this ecosystem. My request to every resident people of jalgaon is watch the beautiful site of Mehrun and take part in maintainance of its beauty.
The lake is a hangout place for jalgaonkars. There are many parks near the lake which attract people. The place is religious for migrants in the city from Uttar Pradesh and Bihar who practice Chhatt Puja at the lake. The Mehrun Bor is a famous fruit in the Jalgaon district.
The municipal corporation of Jalgaon is planning to build a lord Ganesh Temple and renovate the lake to boost tourism.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM mehrunlakecomment";
        $result = mysqli_query($conn, $sql);
        if (
