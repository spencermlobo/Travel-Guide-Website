...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO icchapurtiganeshmandircomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: icchapurti ganesh mandir.php");
  } else {
...
<head>
  ...
  <title>ICCHAPURTI GANESH MANDIR</title>
...
<body>
  ...
  <!--section class="info"-->
  <div class="row">
    <h1>ICCHAPURTI GANESH MANDIR</h1>
    <div class="left-column">
      ...
      <img src="images\Icchapurti Ganesh Mandir.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>Jalgaon vacationer region has ious awesome guest places like Icchapurti Ganesh Mandir and diverse spots to visit in Jalgaon. Icchapurti Ganesh Mandir is in like manner one of the prestigious places in Jalgaon to visit for events with your family or partners. Jalgaon atmosphere and temperature in Jalgaon the two offers extraordinary and perfect agreeable condition to adventurers to make a trek best places to visit in Jalgaon at all measure of time.This empowers explorer to research most of the spots to visit close Jalgaon and around in less time when appeared differently in relation to other climatic conditions. Icchapurti Ganesh Mandir vacationer put offers to a great degree some nice scenes getting live minutes like Animals in The Forest, Water in The Mountains, and Fun in The Sun.</h3>
      <h2>COMMENTS</h2>
      </div>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM icchapurtiganeshmandircomment";
        $result = mysqli_query($conn, $sql);
        if (
