...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO gond_rajacomment (name, email, comment)
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\gond_raja_fort.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM gond_rajacomment";
        $result = mysqli_query($conn, $sql);
        if (
