...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO chandrapur_citycomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: chandrapur_city.php");
  } else {
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\chandrapur_city.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
      Chandrapur is the one of the district located at the east end of the state Maharashtra . Earlier the district was known as Chanda . Firstly it was known as Lokapura ,Some derived the name from "Indupur" (city of the moon) and at the time of British rule it was known as Chanda and then In 1964, it was renamed as Chandrapur. Wardha,Erai,Jharpat are the well known River flows near the city. It is famous for its Super Thermal Power Plant, one of the biggest in Asian continent and it is also known for its vast reserves of coal. the city is also known as "City of Black Gold"as just because of the coal reserves.
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM chandrapur_citycomment";
        $result = mysqli_query($conn, $sql);
        if (
    ...
    <div class="right-column">
      <div class="card">
        ...
        <img src="image\anandwan.jpg" alt="kaas" />
      </div>
      <div class="card">
      <h3><a href="cstps.php">CHANDRAPUR SUPER THERMAL POWER STATION</a></h3>
        <img src="image\cstps.jpg" alt="Maha" />
      </div>
      <div class="card">
      ...
      <h3><a href="mahakali_temple.php">MAHAKALI TEMPLE</a></h3>
        <img src="image\mahakali_temple.jpg" alt="gad" />
      </div>
      <div class="card">
      <h3><a href="tadoba_national_park.php">TADOBA NATIONAL PARK</a></h3>
        <img src="image\tadoba_national_park.jpg" alt="gad" />
      </div>
      <!--div class="card">
                    <h2>POPULAR POST</h2>
