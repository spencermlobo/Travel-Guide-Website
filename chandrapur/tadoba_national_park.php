...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO tadoba_national_parkcomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: tadoba_national_park.php");
  } else {
...
<head>
  ...
  <title>TADOBA NATIONAL PARK</title>
...
<body>
  ...
  <div class="row">
    ...
    <div class="left-column">
      ...
      <img src="image\tadoba_national_park.jpg" width="670" height="300" />
      <div class="center">
      <h2>INFORMATION</h2>
      <h3>
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM tadoba_national_parkcomment";
        $result = mysqli_query($conn, $sql);
        if (
