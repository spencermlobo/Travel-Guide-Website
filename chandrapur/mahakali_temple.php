...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
  ...
  $sql = "INSERT INTO mahakali_templecomment (name, email, comment)
  ...
  if ($result) {
    ...
    header("location: mahakali_temple.php");
  } else {
  ...
  <div class="row">
    ...
    <div class="commentwrapper">
      ...
      <div class="prev-comments">
        ...
        $sql = "SELECT * FROM mahakali_templecomment";
        $result = mysqli_query($conn, $sql);
        if (
